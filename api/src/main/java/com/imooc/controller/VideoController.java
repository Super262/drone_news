...
import utils.FetchVideoCover;
import utils.JSONResult;
import utils.MergeVideoMp3;
...
//				String fileNamePrefix = fileName.split("\\.")[0];
		...
		if (StringUtils.isNotBlank(bgmId)) {
			VideosBgms bgm = bgmService.queryBgmById(bgmId);
...
//		// 对视频进行截图
		...
		video.setVideoSeconds(BigDecimal.valueOf(videoSeconds));
...
//		String fileSpace = "C:/imooc_videos_dev";
	...
	public JSONResult saveComment(@RequestBody VideosComments comment,
