...
@Component
public class Sid {
    private static org.n3r.idworker.WorkerIdStrategy workerIdStrategy;
    ...
    public static synchronized void configure(org.n3r.idworker.WorkerIdStrategy custom) {
        if (workerIdStrategy != null) workerIdStrategy.release();
        workerIdStrategy = custom;
        idWorker = new org.n3r.idworker.IdWorker(workerIdStrategy.availableWorkerId()) {
            @Override
